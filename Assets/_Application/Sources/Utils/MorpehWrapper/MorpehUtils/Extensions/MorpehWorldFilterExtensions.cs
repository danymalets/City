...
namespace Sources.Utils.MorpehWrapper.MorpehUtils.Extensions
{
    ...
    {
        public static FilterBuilder Filter<TComponent>(this DWorld world) where TComponent : struct, IComponent =>
            world.Filter.With<TComponent>();
        
        public static FilterBuilder Filter<TComponent1, TComponent2>(this DWorld world)
            where TComponent1 : struct, IComponent 
            where TComponent2 : struct, IComponent =>
            world.Filter.With<TComponent1>().With<TComponent2>();
        
        public static FilterBuilder Filter<TComponent1, TComponent2, TComponent3>(this DWorld world)
            where TComponent1 : struct, IComponent 
            where TComponent2 : struct, IComponent
            where TComponent3 : struct, IComponent =>
            world.Filter.With<TComponent1>().With<TComponent2>().With<TComponent3>();
        
        public static FilterBuilder Filter<TComponent1, TComponent2, TComponent3, TComponent4>(this DWorld world)
            where TComponent1 : struct, IComponent 
            where TComponent2 : struct, IComponent
            where TComponent3 : struct, IComponent
        ...
        public static FilterBuilder Filter<TComponent1, TComponent2, TComponent3, TComponent4, TComponent5>(this DWorld world)
            where TComponent1 : struct, IComponent 
            where TComponent2 : struct, IComponent
            where TComponent3 : struct, IComponent
            where TComponent4 : struct, IComponent

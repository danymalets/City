...
namespace Sources.Utils.MorpehWrapper.MorpehUtils.Extensions
{
    ...
    {
        public static Filter With<TComponent1, TComponent2>(this Filter filter)
            where TComponent1 : struct, IComponent 
            where TComponent2 : struct, IComponent =>
            filter.With<TComponent1>().With<TComponent2>();
        
        public static Filter With<TComponent1, TComponent2, TComponent3>(this Filter filter)
            where TComponent1 : struct, IComponent 
            where TComponent2 : struct, IComponent
            where TComponent3 : struct, IComponent =>
            filter.With<TComponent1>().With<TComponent2>().With<TComponent3>();
        
        public static Filter With<TComponent1, TComponent2, TComponent3, TComponent4>(this Filter filter)
            where TComponent1 : struct, IComponent 
            where TComponent2 : struct, IComponent
            where TComponent3 : struct, IComponent
        ...
        public static Filter With<TComponent1, TComponent2, TComponent3, TComponent4, TComponent5>(this Filter filter)
            where TComponent1 : struct, IComponent 
            where TComponent2 : struct, IComponent
            where TComponent3 : struct, IComponent
            where TComponent4 : struct, IComponent

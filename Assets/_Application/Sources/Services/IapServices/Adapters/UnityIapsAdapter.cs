...
// {
//     public class UnityIapsAdapter : IDetailedStoreListener, IIapsAdapter
//     {
...
//         
//
//         public UnityIapsAdapter()
//         {
//             _applicationService = DiContainer.Resolve<IApplicationService>();
//             _logger = DiContainer.Resolve<ILogService>().CreateLogger<UnityIapsAdapter>();
//         }
//
...
//             if (IsInitialized)
//             {
//                 _logger.Log($"InitiatePurchase Success");
//
//                 _controller.InitiatePurchase(_products[iapProductType]);
//             }
//             else
//             {
//                 _logger.Log($"InitiatePurchase Error (not initialized)");
//             }
//         }
//         
...
//             {
//                 _logger.Log($"StartRestoreIOS");
//
//                 _extensions.GetExtension<IAppleExtensions>().RestoreTransactions((isSuccess, message) =>
//                 {
//                     if (isSuccess)
//                     {
//                         _logger.Log($"Restore Success");
//
//                         onCompleted?.Invoke();
//                     }
//                     else
//                     {
//                         _logger.Log($"Restore Error message:{message}");
//
//                         onFailed?.Invoke();
//                     }
//                 });
...
//         {
//             _logger.Log($"OnInitialized [{string.Join(",", controller.products.all.Select(p => p.definition.id))}]");
//             
...
//         {
//             _logger.Log($"OnInitializeFailed error:{error}");
//         }
//
//         void IStoreListener.OnInitializeFailed(InitializationFailureReason error, string message)
//         {
//             _logger.Log($"OnInitializeFailed error:{error} message:{message}");
//         }
//
//         public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs purchaseEventArgs)
//         {
//             _logger.Log($"PurchaseCompleted " +
...
//         {
//             _logger.Log($"OnPurchaseFailed product.transactionID:{product.transactionID} " +
...
//             if (IsInitialized)
//             {
//                 price = _products[iapProductType].metadata.localizedPriceString;
//                 return true;
//             }
//             else
//             {

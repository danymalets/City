...
using Sources.Services.AssetsServices.Monos.Bootstrap;
using Sources.Services.AssetsServices.Monos.MonoEntities;
using Sources.Services.AssetsServices.Monos.Points;
using Sources.Services.AssetsServices.Monos.RoadSystem;
using UnityEngine;
